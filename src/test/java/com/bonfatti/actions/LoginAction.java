...
public class LoginAction  extends BaseScreen {
    ...
    public void inputUserName(String email) {
        loginScreen.fieldUserName.isDisplayed();
        loginScreen.fieldUserName.sendKeys(email);
    }
    public void btnContinueClick() {
        loginScreen.btnContinue.isDisplayed();
    ...
    public void btnOkClick() {
        loginScreen.btnOk.click();
    }

    public void doLogin() throws InterruptedException {
        haveAccountClick();
        inputUserName("autom_sem_saldo_2012@mock.com");
        btnContinueClick();
        inputPassWord("testSenha!3");
        btnAccessAccount();
    }
}
